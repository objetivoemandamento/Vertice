...
const r=await fetch(base+"/commands/"+encodeURIComponent(foreignCommand)+"/status",{method:"POST",headers:{"Authorization":"Bearer "+tokenA,"Content-Type":"application/json","Idempotency-Key":"rls-"+crypto.randomUUID()},body:JSON.stringify({status:"completed",deviceId:foreignDevice})});
